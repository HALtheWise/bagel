"""
This file is automatically maintained by Gazelle

To update, run
    bazel run //tools:gazelle -- update-repos -from_file=go.mod -to_macro=deps.bzl%go_deps
"""
...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:kP6+OyvR0fuBH6UhbE6yh/nskrDEIQgEA1SUXDPjx4g=",
        version = "v1.3.1",
    )
